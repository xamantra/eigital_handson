...
class MapPageState extends State<MapPage> {
  ...
  setPolylines() async {
    final result = polylinePoints.decodePolyline('kf|cGvlkqLlCbJhYcLnAtIfHzB~DpHpe@zqA~FzWlDb`@cBbM}N|VG`HzC~F|YwAhaAt^jp@zGptAgIbu@iTxA|EaIpFdAbMfKzTrFeE`BjBqDjA');
